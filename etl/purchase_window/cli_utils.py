...
def build_stage_parser(description: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-dir", help="Optional override for template/purchase_window/input directory")
    parser.add_argument("--output-dir", help="Optional override for template/purchase_window/output directory")
