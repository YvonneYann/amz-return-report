...
from .config import DEFAULT_DATA_DIR, DEFAULT_OUTPUT_DIR, PathConfig


class DorisClient(_BaseDorisClient):
    """
    Purchase-window Doris client that pulls data into the purchase_window template paths,
    using purchase_date windows for orders/facts.
    """
